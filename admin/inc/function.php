<?php
    ...
    function view_lang()
    {
        ...
        while($row=$get_lang->fetch()):
            echo"<tr>
                    ...
                    <td>".$row['lang_name']."</td>
                    <td>
                        <a href='index.php?lang&edit_lang=".$row['lang_id']."' title='Edit'><i class='far fa-edit'></i></a>
    ...
    function view_cat()
    {
        ...
        while($row=$get_cat->fetch()):
            echo"<tr>
                    ...
                    <td>
                        <a href='index.php?cat&edit_cat=".$row['cat_id']."' title='Edit'><i class='far fa-edit'></i></a>
    ...
    function view_sub_cat()
    {
        ...
        while($row=$get_cat->fetch()):
            ...
            echo"<tr>
                    ...
                    <td>
                        <a href='index.php?sub_cat&edit_sub_cat=".$row['sub_cat_id']."' title='Edit'><i class='far fa-edit'></i></a>
    ...
    function view_term()
    {
        include("inc/db.php");
            ...
            echo"<tr>
                    ...
                    <td>".$row['for_whome']."</td>
                    <td>
                        <a href='index.php?terms&edit_term=".$row['t_id']."' title='Edit'><i class='far fa-edit'></i></a>
    ...
    if(isset($_POST['up_con']))
    {
        ...
        $up=$con->prepare("update contact set phn='$phn',email='$email', add1='$add1',add2='$add2',yt='$yt',fb='$fb',gp='$gp',tw='$tw',link='$li'");
        if($up->execute())
        {
